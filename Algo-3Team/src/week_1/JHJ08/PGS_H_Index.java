...
public class PGS_H_Index {
	...
	static public int solution(int[] citations) {
        ...
        // 정렬 => [0, 1, 3, 5, 6]
        // 0번 이상 인용된 논문 수 : citations.length(=5)
        // 1번 이상 인용된 논문 수 : citations.length(=5) - 1 = 4
        // 3번 이상 인용된 논문 수 : citations.length(=5) - 2 = 3
        // 5번 이상 인용된 논문 수 : citations.length(=5) - 3 = 2
        // 6번 이상 인용된 논문 수 : citations.length(=5) - 4 = 1
